...
/*   Updated: 2016/11/16 21:55:33 by kmurray          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "bsq.h"

void	print_bsq(int **arr, int max, char *map, char *instr)
{
	int i;
	int j;
...
int		i_coords(int **arr, int max, char *map, char *instr)
{
	int i;
	int j;
	int a;
...
int		j_coords(int **arr, int max, char *map, char *instr)
{
	int i;
	int j;
	int a;
...
void	make_bsq(int **arr, int max, char *map, char *instr)
{
	...
	i = i_coords(arr, max, map, instr);
	j = j_coords(arr, max, map, instr);
	a = i;
	b = j;
	while (i < ft_nbr_lines(instr) && arr[i][j] != max)
	{
